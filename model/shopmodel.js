...
module.exports.fetchUserShopItems = (user_id, callback) => {
  const SQLSTATEMENT = `
    SELECT Shopitems.id, Shopitems.name, Shopitems.type, Shopitems.asset_url, Usershopitems.equipped
    FROM Usershopitems
...
//ALl we are doing is simplyt jsut unequipping all items of one type before equipping the new item
